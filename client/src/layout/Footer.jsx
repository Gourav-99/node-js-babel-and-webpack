...
const Footer = () => {
  return (
    <div className="footer-1 py-4 sm:py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t">
          ...
          <div className="px-4 md:w-1/4 md:ml-auto mt-6 sm:mt-4 md:mt-0">
            <button className="text-yellow-900 px-4 py-2 rounded  transition bg-gradient-to-b from-yellow-200 to-yellow-300 hover:to-red-300 active:from-yellow-400 focus:from-red-400">
              Get Started
            </button>
          </div>
        </div>
